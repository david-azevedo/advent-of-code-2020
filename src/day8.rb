...
def run_program(lines)
  ...
  offset = 0
  offsets_seen = {}
  # Small otimization for Part 2 only storing jmp and nop instructions that might be incorrect
...
# Part 2: Iterating through all the seen instructions in the first run and editing one by one
# and checking if that swap makes the program terminate. If yes we have found the solution
